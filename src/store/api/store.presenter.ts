...
import { StoreView } from 'src/store/application/store.view';
import { CreateStoreDto } from 'src/store/api/dto/request/create-store.dto';
...
import { UpdateStoreDto } from 'src/store/api/dto/request/update-store.dto';
