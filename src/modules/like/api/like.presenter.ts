...
import { CakeLikeView } from 'src/modules/cake/application/port/cake-like.port';
import { LikedStoreCatalogView } from 'src/modules/catalog/application/port/liked-store-catalog.reader';
