...
import { UserNotOwnerException } from 'src/modules/user/exceptions/user-not-owner.exception';
...
import { S3UploadException } from 'src/integrations/media/exception/s3-upload.exception';
