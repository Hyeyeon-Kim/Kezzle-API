...
import {
  CakeLikePort,
  CakeLikeView,
} from 'src/cake/application/port/cake-like.port';
import { CakeAlreadyLikedException } from 'src/cake/domain/exception/cake-already-liked.exception';
import {
  LikedStoreCatalogReader,
  LikedStoreCatalogView,
} from 'src/catalog/application/port/liked-store-catalog.reader';
import { StoreAlredyLikeException } from 'src/store/domain/exception/store-already-like.exception';
