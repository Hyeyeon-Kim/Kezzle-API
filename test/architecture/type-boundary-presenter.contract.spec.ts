import { CakePresenter } from 'src/cake/api/cake.presenter';
import { ImageExternalMapper } from 'src/common/image/image-external.mapper';
import { CurationPresenter } from 'src/curation/api/curation.presenter';
import { RankingPresenter } from 'src/ranking/api/ranking.presenter';
import { SearchPresenter } from 'src/search/api/search.presenter';
import { StorePresenter } from 'src/store/api/store.presenter';
import { Roles } from 'src/user/domain/roles.enum';
import { UserPresenter } from 'src/user/api/user.presenter';
